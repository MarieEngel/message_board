...
urlpatterns = [
    ...
    path("<int:post_id>/comment/<int:comment_id>/delete/", post_views.DeleteCommentView.as_view(), name="delete-comment"),
    path("<int:post_id>/comment/<int:comment_id>/update/", post_views.UpdateCommentView.as_view(), name="update-comment"),
]
